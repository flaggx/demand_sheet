...
export function SupabaseSetupHint() {
  ...
  return (
    <div className="mt-6 max-w-md rounded-lg border border-amber-400/40 bg-amber-500/10 p-4 text-left text-sm text-neutral-100">
      <p className="font-medium text-amber-200/90">Next: connect Supabase</p>
      <ol className="mt-2 list-decimal space-y-1 pl-5 text-neutral-200">
        <li>Create a project at supabase.com</li>
        <li>
          Dashboard → <strong>Project Settings</strong> → <strong>API Keys</strong>: copy
          the <strong>Publishable</strong> key (<code className="text-neutral-300">sb_publishable_…</code>)
        </li>
        <li>
          Same page: copy <strong>Project URL</strong> (or use the Connect dialog)
        </li>
        <li>
          Put them in <code className="text-neutral-300">.env.local</code> — see{" "}
          <code className="text-neutral-300">.env.local.example</code>
        </li>
        <li>
          Legacy <strong>anon</strong> JWT still works via{" "}
          <code className="text-neutral-300">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> if you
